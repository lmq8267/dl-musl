...
if [ -z "$TARGET" ]; then
        echo -e "\033[31;47m 【错误】 \033[0m\033[31;47m  未设置目标架构的 TARGET 值   \033[0m"
        exit 1
fi
if [ -z "$GCCPTAH" ]; then
        echo -e "\033[32;47m  \033[0m\033[32;47m 设置musl-gcc下载目录为/opt/musl_gcc/  \033[0m"
...
case "$TARGET" in
    ...
    *)
        ...
        echo -e "\033[31;47m  \033[0m\033[31;47m  请在以下支持的架构列表里选一个  \033[0m"
